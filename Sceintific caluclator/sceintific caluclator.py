...
def arcsin_clicked():
    try:
        ans = float(disp.get())
        if ans<-1 or ans>1:
            tkinter.messagebox.showerror("Value Error", "values are out of range")
            return
        if switch is True:
...
pow_btn = Button(btnrow3, text="pow", font="Segoe 17", relief=GROOVE, bd=0, command=pow_clicked, fg="white", bg="#333333")
...
btnd = Button(btnrow5, text="//", font="Segoe 23", relief=GROOVE, bd=0, command=btnfdiv_clicked, fg="white", bg="#333333")
btnd.pack(side=LEFT, expand=TRUE, fill=BOTH)
btnd = Button(btnrow5, text="ceil", font="Segoe 23", relief=GROOVE, bd=0, command=btnceil_clicked, fg="white", bg="#333333")
btnd.pack(side=LEFT, expand=TRUE, fill=BOTH)
btnd = Button(btnrow5, text="floor", font="Segoe 23", relief=GROOVE, bd=0, command=btnfloor_clicked, fg="white", bg="#333333")
btnd.pack(side=LEFT, expand=TRUE, fill=BOTH)
btnd = Button(btnrow5, text="inverse", font="Segoe 23", relief=GROOVE, bd=0, command=btninv_clicked, fg="white", bg="#333333")
btnd.pack(side=LEFT, expand=TRUE, fill=BOTH)
root.mainloop()